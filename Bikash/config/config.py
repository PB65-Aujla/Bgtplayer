...
OWNER_ID = list(map(int, getenv("OWNER_ID", "6608713615").split()))
HEROKU_API_KEY = getenv("HEROKU_API_KEY", None)
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME", None)
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/PB65-Aujla/Bgtplayer")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "bikash")
GIT_TOKEN = getenv("GIT_TOKEN", None)
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/The_Support_World")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/The_ChatGroup")
...
START_IMG_URL = getenv("START_IMG_URL", "https://graph.org/file/8a4a62d3a2d956d43d117.jpg")
PING_IMG_URL = getenv("PING_IMG_URL", "https://graph.org/file/8a4a62d3a2d956d43d117.jpg")

PLAYLIST_IMG_URL = "https://graph.org/file/8a4a62d3a2d956d43d117.jpg"
GLOBAL_IMG_URL = "https://graph.org/file/8a4a62d3a2d956d43d117.jpg"
